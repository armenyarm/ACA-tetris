...
/*
 ...
 -a timer object calls tick(Move.DOWN) periodically
 -keystrokes call tick() with Move.LEFT, Move.RIGHT, etc.
...
public class JTetris extends JComponent {
	...
	JTetris(int pixels) {
		...
		/*
		 ...
		 e.g. 'j' and '4'  call tick(Move.LEFT)
	...
	*/
	public JComponent createControlPanel() {
		...
		speed.setPreferredSize(new Dimension(200, 50));
